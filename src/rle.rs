...
#[pyfunction]
pub fn rle_encode<'py>(py: Python<'py>, data: PyReadonlyArrayDyn<u64>) -> &'py PyArray1<u64> {
...
#[pyfunction]
pub fn rle_decode(py: Python, data: PyReadonlyArrayDyn<u64>, width: Option<usize>, height: Option<usize>) -> Py<PyArrayDyn<u64>> {
